 ...
 */
public class RatingFragment extends Fragment implements RatingAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new RatingAdapter(myDataset,  this);
        editPoductPageFragment = new RatingMovieFragment();
